...
class RelationshipType(models.Model):
    project = models.ForeignKey(
        Project, on_delete=models.CASCADE, related_name='relationship_types'
    )
    name = models.CharField(max_length=100)
    description = models.TextField(blank=True)
...
class Alternative(models.Model):
    project = models.ForeignKey(
        Project, on_delete=models.CASCADE, related_name='alternatives'
    )
    ...
    criteria_values = models.JSONField(default=dict, blank=True)
...
class Relation(models.Model):
    ...
    source = models.ForeignKey(
        Alternative, on_delete=models.CASCADE, related_name='outgoing_relations'
    )
    target = models.ForeignKey(
        Alternative, on_delete=models.CASCADE, related_name='incoming_relations'
    )
    ...
    def __str__(self):
        return (
            f"{self.source} {self.get_relation_type_display()} {self.target}"
        )
