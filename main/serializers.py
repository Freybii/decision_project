...
from .models import (
    Project, Alternative, Relation, RelationshipType, Criterion, Like
)
...
class AlternativeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Alternative
        fields = [
            'id', 'name', 'description', 'rating', 'criteria_values',
...
class RelationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Relation
        fields = [
            'id', 'source', 'target', 'source_id', 'target_id', 'relation_type'
        ]
        read_only_fields = ['id']
...
class ProjectSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Project
        fields = [
            'id', 'title', 'description', 'is_public', 'image', 'user',
